...
class TitulosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create titulo" do
    assert_difference("Titulo.count") do
      post titulos_url, params: { titulo: { conteudo_text: @titulo.conteudo_text, data_evento: @titulo.data_evento, l_categoria_id: @titulo.l_categoria_id } }
    end
  ...
  test "should update titulo" do
    patch titulo_url(@titulo), params: { titulo: { conteudo_text: @titulo.conteudo_text, data_evento: @titulo.data_evento, l_categoria_id: @titulo.l_categoria_id } }
